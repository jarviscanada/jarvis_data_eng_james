...
DROP TABLE IT EXISTS PUBLIC.host_info;
...
DROP TABLES IF EXISTS PUBLIC.host_usage;
...
INSERT INTO host_usage ('timestamp', host_id, memory_free, cpu_idel, cpu_number, disk_io, disk_available) VALUES ('2019-05-29 16:53:28', 1, 256, 95, 0, 0, 31220);
